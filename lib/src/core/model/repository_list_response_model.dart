...
//
//     final repositoryListResponse = repositoryListResponseFromJson(jsonString);
...
class RepositoryListResponse {
  ...
  factory RepositoryListResponse.fromRawJson(String str) =>
      RepositoryListResponse.fromJson(json.decode(str));
